...
class Tokenizer:
    ...
    def __init__(self, lang, bpe_fname):
        ...
        self.bos = self.dictionary.eos_word  # <s>
        self.bos_id = self.dictionary.eos_index  # 0
        self.eos = self.dictionary.eos_word  # </s>
        self.eos_id = self.dictionary.eos_index  # 2
        self.pad = self.dictionary.pad_word  # <pad>
        self.pad_id = self.dictionary.pad_index  # 1
        self.unk = self.dictionary.unk_word  # <unk>
        self.unk_id = self.dictionary.unk_index  # 3
